...
const BLOCKS = [
  {
    ...
    body: [
      ...
      "CREPE устойчив к тембру: перегруз, компрессор и струны с обмоткой почти не сбивают модель, потому что она обучалась на сыром волновом сигнале, а не на нотах. torch-порт (torch-mel-crepe) переносит инференс на MPS без переписывания пайплайна.",
    ],
  ...
  },
  {
    ...
    snippet: "mel_crepe.predict(..., viterbi=True)  →  medfilt(confidence, 5)",
  },
  {
    id: "cents",
