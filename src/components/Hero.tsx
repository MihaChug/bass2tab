...
const LINES: TermLine[] = [
  ...
  { text: "  CREPE full · чанк 8/8 [████████████████] 100% · 6 c", cls: "text-phos", pause: 300 },
  { text: "· CREPE-full (mps): 28 240 фреймов · 8 чанков · 6.3 c", cls: "text-phos", pause: 300 },
  { text: "· онсеты, темп и сегментация…", cls: "text-dim", pause: 200 },
  { text: "· сегментация: 196 нот · темп 118 BPM · сетка 1/16", cls: "text-dim", pause: 300 },
  { text: "· экспорт (midi, musicxml, gp5)…", cls: "text-dim", pause: 160 },
  { text: "  экспорт · gp5 [████████████████] 100%", cls: "text-phos", pause: 260 },
