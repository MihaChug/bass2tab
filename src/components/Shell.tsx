...
export function Logo({ size = 34 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" aria-hidden="true">
      <rect x="1" y="1" width="38" height="38" rx="9" fill="#161e24" stroke="#263139" />
      <line x1="8" y1="12" x2="32" y2="12" stroke="#5d6d75" strokeWidth="3.4" strokeLinecap="round" />
      <line x1="8" y1="18" x2="32" y2="18" stroke="#8fa0a8" strokeWidth="2.4" strokeLinecap="round" />
      <line x1="8" y1="23.5" x2="32" y2="23.5" stroke="#8fa0a8" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="8" y1="28" x2="32" y2="28" stroke="#5d6d75" strokeWidth="1" strokeLinecap="round" />
  ...
  return (
    <Reveal className="max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <span id={id} className="font-mono text-[11px] font-medium uppercase tracking-[0.22em] text-amber scroll-mt-28">
          {kicker}
        </span>
      </div>
...
export function CopyButton({
  ...
  return (
    <button
      type="button"
      onClick={onCopy}
      className={`group inline-flex shrink-0 cursor-pointer items-center gap-1.5 rounded-md border font-mono text-[11px] font-medium transition-colors duration-200 ${
        copied
