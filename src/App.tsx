            ...
            <div className="mt-5 grid gap-5 md:grid-cols-3">
              ...
              <div>
                ...
                <p className="mt-2.5 text-[13px] leading-relaxed text-dim">
                  ...
                  фантомные ноты в тишине исчезают. Намеренно не A-взвешенно: A-вес
                  глушит бас на 22–43 дБ и обнулял бы весь трек.
                </p>
              </div>
              <div>
                <div className="flex items-center gap-2">
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Если нот меньше пяти, CLI печатает диагностику: «· уверенность CREPE: p50 … p90 … · кадров ≥ 0.60: N%» и готовый совет «--on-thr X --off-thr Y» (порог активации ~ 75-й процентиль уверенности). Два сценария. (1) p90 ≈ 0 — уверенность обнулена целиком: почти наверняка старая версия pitch.py с A-взвешенным Silence (см. предыдущий пункт) — обновите файл. (2) p90 высокий, а нот 0 — запись тихая/перегруженная и пики уверенности не дотягивают до 0.6: просто запустите с предложенными порогами.",
  },
];
