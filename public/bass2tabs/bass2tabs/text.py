...
кодировках (фактически latin-1 / cp1252). UTF-8 туда не помещается, поэтому
кириллицу и прочие не-latin-1 символы транслитерируем в читаемую латиницу.
MusicXML — это XML в UTF-8, ему данная обработка не нужна.
"""
